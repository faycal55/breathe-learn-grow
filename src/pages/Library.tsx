...
const CATEGORIES: Record<string, Work[]> = {
  "Deuil & Résilience": [{
    ...
    url: "https://fr.wikisource.org/wiki/M%C3%A9moires_d%E2%80%99outre-tombe"
  }, {
    title: "Poésies nouvelles",
    author: "Alfred de Musset",
    url: "https://fr.wikisource.org/wiki/Po%C3%A9sies_nouvelles_(Musset)"
  }, {
    title: "Les Fleurs du mal (sélection)",
  ...
  "Solitude & Anxiété": [{
    ...
    url: "https://fr.wikisource.org/wiki/Les_Confessions_(Rousseau)"
  }, {
    title: "Les Caractères",
    author: "Jean de La Bruyère",
    url: "https://fr.wikisource.org/wiki/Les_Caract%C3%A8res"
  }],
  "Estime de soi & Sagesse": [{
    ...
    url: "https://fr.wikisource.org/wiki/Discours_de_la_m%C3%A9thode"
  }, {
    ...
    url: "https://fr.wikisource.org/wiki/Maximes_(1678)"
  }, {
  ...
  "Mémoire & Séparation": [{
    ...
    url: "https://fr.wikisource.org/wiki/Madame_Bovary"
  }, {
    title: "Manon Lescaut",
    author: "Abbé Prévost",
    ...
    url: "https://fr.wikisource.org/wiki/Carmen_(M%C3%A9rim%C3%A9e)"
  }, {
    title: "Lettres (sélection)",
    author: "Madame de Sévigné",
    url: "https://fr.wikisource.org/wiki/Lettres_de_la_Marquise_de_S%C3%A9vign%C3%A9"
  }]
};
        ...
        {Object.entries(CATEGORIES).map(([theme, items]) => <Card key={theme}>
            ...
            <CardContent>
              <ul className="list-disc pl-5 space-y-2 text-sm">
                {items.map(it => <li key={`${theme}-${it.title}`}>
